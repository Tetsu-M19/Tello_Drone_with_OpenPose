...
class Tello_Pose:
    def __init__(self):
        ...
        self.protoFile = "Tello_Video_Pose_Recognition/model/pose/mpi/pose_deploy_linevec_faster_4_stages.prototxt"
        self.weightsFile = "Tello_Video_Pose_Recognition/model/pose/mpi/pose_iter_160000.caffemodel"
